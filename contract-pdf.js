...
window.ContractPDF = (function(){
  ...
  function buildHTML(d){
    ...
    return '<div class="cp-page">'
      ...
      +'<div class="cp-clausula"><strong>9. Datos Personales</strong><span>Los datos facilitados serán tratados por ORIGAMI COSMETICS S.L. con la finalidad de gestionar la relación contractual y prestar los servicios objeto de este contrato, sobre la base de la ejecución del contrato (art. 6.1.b RGPD). Se conservarán durante la vigencia de la relación y los plazos legales aplicables. LA CLIENTA puede ejercer sus derechos de acceso, rectificación, supresión, oposición, limitación y portabilidad en inesanchezbeautyconcept@gmail.com, y presentar reclamación ante la AEPD (www.aepd.es). Uso de imágenes con fines publicitarios: tratamiento independiente, que no condiciona la prestación del servicio. LA CLIENTA otorga su consentimiento marcando la casilla del Anexo de Consentimiento de Imagen, revocable en cualquier momento.</span></div>'
